...
#define Latch_On 1
    ...
    **/
    ...
    #define PIN_HC74595_CLK_TRIS_PORT_2    TRISBbits.TRISB7
    #define PIN_HC74595_CLK_LAT_PORT_2     LATBbits.LATB7
    #define PIN_HC74595_LATCH_TRIS_PORT_2    TRISBbits.TRISB8
    #define PIN_HC74595_LATCH_LAT_PORT_2     LATBbits.LATB8
    #define PIN_HC74595_DATA_TRIS_PORT_2    TRISAbits.TRISA7
    #define PIN_HC74595_DATA_LAT_PORT_2    LATAbits.LATA7
    #define PIN_HC74595_OEN_TRIS_PORT_2    TRISFbits.TRISF0
    #define PIN_HC74595_OEN_LAT_PORT_2   LATFbits.LATF0
